                        ...
                        <div class="authentication-box">
                            <div class="card to-shake mt-4 p-4">
                                <form class="theme-form">
                                    <h5 class="f-16 mb-3 f-w-600"> Edit DLivestock </h5>
    ...
    watch: {
        DLivestockData: {
            ...
            handler() {
                ...
                this.form.category.value = this.DLivestockData.category == null ? "" : this.DLivestockData.category
                this.form.type.value = this.DLivestockData.type == null ? "" : this.DLivestockData.type
                this.form.id = this.DLivestockData.id == null ? "" : this.DLivestockData.id
        ...
        create: function() {
            ...
            if(this.form.category.value == '') {
                ...
                setTimeout(function() {
                    ...
                    axios.put(`${ApiUrl.url}d-livestock/${this.form.id}`, data, headers) 
                    .then( (resp) => {
                        setTimeout(function() {
    
                            self.loading = false
                            self.$emit("dlivestock-update-success", resp.data.data)
                            self.$toasted.show(`DLivestock Updated Successfully`, {theme: 'outline',position: "top-right", icon : 'check', type: 'success', duration: 8000})
                            Custombox.modal.close()
