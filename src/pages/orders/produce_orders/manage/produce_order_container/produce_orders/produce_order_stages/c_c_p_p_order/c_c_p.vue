<template>
    ...
    <div v-if="Object.keys(c_c_p_p_order_data).length > 0" class="col-md-6">
        <div class="card">
        <div class="card-body">
            ...
            <div class="media-body text-left align-self-center">
                <h6> {{ c_c_p_p_order_data.purpose }} </h6>
            </div>
            </div>
...
export default {
    ...
    props: {
        c_c_p_p_order: Object
    },
    watch: {
        c_c_p_p_order: {
            immediate: true,
            handler() {
                if(Object.keys(this.c_c_p_p_order).length > 0) this.c_c_p_p_order_data = this.c_c_p_p_order
            }
        }
    },
    methods: {
        delete_it: function() {
            ...
            axios.delete(`${ApiUrl.url}c-c-p-p-orders/${this.c_c_p_p_order_data.id}`, headers)
            .then( (resp) => {
                ...
                if(resp.status == 204) {
                    ...
                    this.$emit("file-delete-success", {id: this.c_c_p_p_order_data.id})
