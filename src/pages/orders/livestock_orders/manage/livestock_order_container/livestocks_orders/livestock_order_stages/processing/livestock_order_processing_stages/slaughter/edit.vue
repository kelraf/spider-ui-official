    ...
    <div class="container-fluid">
        <div @click.self="close" class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="card"> 
                    <div class="card-body">
                        <form-wizard color="#4466f2" :start-index="0" title="Edit A Slaughter Order" subtitle="Split a complicated flow in multiple steps" back-button-text="Go back!" next-button-text="Go next!" finish-button-text="We're there">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-6 offset-md-3">
                                                <button :disabled="loading ? true : false" @click="sendRequest" id="default-outline-warning" type="button" class="btn btn-pill btn-outline-warning btn-block">
...
export default {
    ...
    watch: {
        currentOrder: {
            ...
            handler() {
                ...
                if(!this.current_order.status) return

                let {dates, description, business_id, business, id} = this.current_order
    ...
    methods: {
        ...
        sendRequest() {
            ...
            if(Object.keys(this.current_order).length <= 0) return
