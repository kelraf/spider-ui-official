   ...
   <!-- page-wrapper Start-->
    <div class="page-wrapper">
        <div class="container-fluid">
            <!-- sign up page start-->
            <div class="authentication-main" @click.self="close" style="background: transparent;">
                <div class="row">
                        ...
                        <div class="auth-innerright">
                            <div class="authentication-box">
                                ...
                                <div class="card to-shake mt-4 p-4">
                                    <h4 class="text-center"> Create S I ADMIN </h4>
                                    <h6 class="text-center"> Provide Details To Create </h6>
                                    <form class="theme-form">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 offset-md-4">
                                                <button @click="signUp" id="default-outline-primary" type="button" class="btn btn-sm btn-pill btn-outline-primary mt-2 mb-2 btn-block">
