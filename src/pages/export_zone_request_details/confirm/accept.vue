        ...
        <div @click.self="close" class="row p-3 pt-5">
            <div style="height: 50vh;" class="col-md-4 col-xl-4 bg-white offset-md-4 offset-xl-4 pt-5 modal-col">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12 font-success text-center pt-3">
                            <i class="fa fa-question-circle fa-4x"></i>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-12 text-center font-success pt-4">
                            <h5>
                                <b class="font-success"> Are You Sure To Accept This Request ?</b>
                            </h5>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        go() {
            ...
            delete this.action_data.status
            delete this.action_data.action
            delete this.action_data.livestock_order
            ...
            axios.put(`${ApiUrl.url}export-zone-livestock-orders/${this.action_data.id}`, data, headers) 
            .then( (resp) => {

                setTimeout(function() {

                    self.loading = false
                    self.$emit("export-zone-request-edit-success", resp.data.data)
                    self.$toasted.show(`Export Zone Request Accepted.`, {theme: 'outline', position: "top-right", icon : 'check', type: 'success', duration: 8000})
                    Custombox.modal.close()
