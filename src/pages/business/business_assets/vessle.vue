    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row pt-4">
                ...
                <div class="col-4">
                    <button id="default-outline-primary" type="button" @click="create_vessle" class="btn btn-pill btn-outline-primary mt-2 mb-2 btn-block">
                        <i class="icon-plus"></i>
                    </button>
                </div>
        ...
        <CreateVessle id="create-vessle" style="display: none;" :businessProfile="businessProfile" />
