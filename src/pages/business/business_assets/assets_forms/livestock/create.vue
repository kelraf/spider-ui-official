    ...
    methods: {
        ...
        get_dlivestock() {
			...
			.then( (resp) => {
                ...
                this.form.livestock.options = data;
        ...
        create: function() {
            ...
            if(this.form.livestock_value.value == '') {
                ...
                this.$toasted.show(`Oops!! Something Went Wrong. Please Try Again. ccccc`, {theme: 'outline',position: "top-right", icon : 'times', type: 'error', duration: 4000})
            ...
            } else if(Object.keys(this.form.livestock_value.value).length > 0) {
                    ...
                    axios.post(`${ApiUrl.url}livestocks`, data, headers) 
                    .then( (resp) => {
                        setTimeout(function() {
                ...
                this.$toasted.show(`Oops!! Something Went Wrong. Please Try Again. xxxxx`, {theme: 'outline',position: "top-right", icon : 'times', type: 'error', duration: 4000})
            }
