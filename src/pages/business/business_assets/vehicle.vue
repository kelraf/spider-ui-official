    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row pt-4">
                ...
                <div class="col-4">
                    <router-link id="default-outline-primary" :to="'/businesses/all-vehicles/'+businessProfile.id" type="button" class="btn btn-pill btn-outline-primary mt-2 mb-2 btn-block"> 
                        <i class="icon-eye"></i>
                    </router-link>
                </div>
